...
<script>
	$(function() {
       ...
       */
       console.log("div:first-child의 innerHTML : ",$('div:first-child').html()); // 네이버가 선택된다.
       console.log("div:first의 innerHTML : ",$('div:first').html()); // div1이 선택된다.
       console.log("div:eq(0)의 innerHTML : ",$('div:eq(0)').html()); // div1이 선택된다.
       console.log($("div:last-child").length);  //2나온다 fieldset안에 div 하나 + div안에 div
       //$("div:last-child").css("color","red"); //모든 선택된 div에 적용됨
       console.log($("div:last-child").html()); // 네이트만 반환 String 반환해서 하나밖에 값을 출력 못한다.(원래는 2개)
       ...
       $('button').click(function(){
    		...
    		//즉 이벤트 핸들러 안에서 $(this)는 해당 이벤트가 발생한 객체 의미
