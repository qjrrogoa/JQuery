...
<script>
	$(function() {
		...
		$('#get').on('click',function(){
			...
			console.log("배경색 : %s",back,div.get(0).style.backgroundColor);
		...
		$('a').on('click',function(){
			...
			switch($(this).html()){
				case "크게":
					pTag.css("font-size",fontSize+5+'px');
					break;
				case "작게":
					pTag.css("font-size",fontSize-5+'px');
					break;
...
<body>
	<fieldset>
		...
		<p id="article" style="font-size: 12px">
			기사 내용입니다<br /> 기사 내용입니다<br /> 기사 내용입니다<br /> 기사 내용입니다<br /> 기사 내용입니다<br />
		</p>
