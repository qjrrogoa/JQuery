...
<script>
	$(function() {
		...
		console.log($('a[href]').length); //3    JQuery 객체
		document.getElementsByTagName('a')[0] // 쟈스Dom객체
		...
		//3]$("선택자:contatins('문자열')"):시작태그와 종료태그 사이의 내용으로 선택
		$("a:contains('이')").css('background-color','black');
		
		//4]$("선택자:even") 혹은 $("선택자:odd").인덱스는 0부터
		//짝수번째는 빨간, 홀수번째는 그린을 배경색 적용]
		...
		$('tr:first-child').css('background-color','white');
